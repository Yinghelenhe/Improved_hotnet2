...
from hotnet2 import run as hnrun, hnap, hnio, heat as hnheat, consensus_with_stats, viz as hnviz, hotnet2 as hn, My_Function as my
...
def run(args):
    ...
    single_runs, single_My_results, consensus, linkers, auto_deltas, consensus_stats = consensus_with_stats(args, networks, heats)
